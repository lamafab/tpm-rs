...
use tpm2_rs_base::{
    commands::TpmCommand, constants::TpmHandle, Tpm2bAuth, Tpm2bData, Tpm2bDigest, Tpm2bName,
    Tpm2bNonce, Tpm2bPublic, Tpm2bSimple, TpmaSession, TpmiShAuthSession, TpmsAuthCommand,
    TpmsAuthResponse,
};
    ...
    D: AlgoDigest,
{
    ...
    pub fn set_object_name(&mut self, name: Tpm2bName) {
    ...
    D: AlgoDigest,
{
    fn get_auth_command<CmdT: TpmCommand>(
        ...
        let cp_hash = cp_hash::<CmdT, D::Hasher>(cmd, cmd_handles, self.object_name, buf)?;
